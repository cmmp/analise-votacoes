...
ano = 2015
basepath = wd + str(ano) + '/votacoes/'

codigos = [] # codigos das proposicoes
datas   = [] # datas das votacoes

with open(wd + "votadas-" + str(ano) + ".csv", 'r') as csvfile:
...
with open(wd + "series-votacoes-" + str(ano) + ".csv", 'w') as outfile:
    ...
    with open(wd + "deputados.csv", 'r') as depfile:
